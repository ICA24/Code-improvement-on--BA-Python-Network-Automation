from functions import filtersGroups
from PythonNetworkAutomation.functions.SendCLIcommand import CLIcommands
from PythonNetworkAutomation.functions import templateNameServer
from PythonNetworkAutomation.functions import templateOSPF
from PythonNetworkAutomation.functions import compareConfig
from PythonNetworkAutomation.functions import filtersSpecific
from PythonNetworkAutomation.functions import backupFunct
import subprocess
...
def EditHostsFile():
	...
	subprocess.call([r"C:\Program Files\Notepad++\notepad++.exe", r"D:\v1.1\mypackage\appdata\hosts.yml"])

def openHostsYAML():
	hostsYAML = open("appdata/hosts.yml")
